...
transported to the integral short model, are in `data/curve240.txt`; descent labels are in
`data/curve240-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve240_j : curve240.j = -3705972557857231372289575910655297107980165442217318653229095850707137 / 108751445929391105693003663709330401851059569537300943313379657964 := j_eq_iff.mpr (by decide +kernel)
