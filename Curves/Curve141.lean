...
transported to the integral short model, are in `data/curve141.txt`; descent labels are in
`data/curve141-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve141_j : curve141.j = -37110044223081690097367665230553544486755946267474321567766859966249 / 516510413442146499141074184196230628833010080720238510080000000 := j_eq_iff.mpr (by decide +kernel)
