...
transported to the integral short model, are in `data/curve248.txt`; descent labels are in
`data/curve248-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve248_j : curve248.j = -2838472467928799790392654545441 / 203857978518193703 := j_eq_iff.mpr (by decide +kernel)
