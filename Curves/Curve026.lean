...
@[expose] public def curve026 : WeierstrassCurve ℚ := ⟨0, -1, 0, -1485019900716, 658252007072023716⟩

/-- ICARM leaderboard curve 26 has Mordell-Weil rank at least `7`. -/
public theorem curve026_hasRankGE_7 : HasRankGE curve026 7 := by
  unfold curve026
  certify_curve oneTorsion 2256804 43 "data/curve026.txt" "data/curve026-labels.txt"

/-- Curve 26 is elliptic (nonzero discriminant), so its `j`-invariant is defined. -/
public instance : curve026.IsElliptic := isElliptic_of_Δ_ne_zero (by decide +kernel)

set_option linter.style.longLine false in
/-- The `j`-invariant of curve 26. -/
public theorem curve026_j : curve026.j = 27930286822977979655852256482253328 / 1728175896617050441636406899425 :=
