...
transported to the integral short model, are in `data/curve17.txt`; descent labels are in
`data/curve17-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve17_j : curve17.j = 3985540964247579921431463460864 / 29681063325213354456927525 := j_eq_iff.mpr (by decide +kernel)
