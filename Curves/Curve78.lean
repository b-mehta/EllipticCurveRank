...
transported to the integral short model, are in `data/curve78.txt`; descent labels are in
`data/curve78-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve78_j : curve78.j = 909031208520136752441 / 643509175703572 := j_eq_iff.mpr (by decide +kernel)
