...
transported to the integral short model, are in `data/curve265.txt`; descent labels are in
`data/curve265-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve265_j : curve265.j = 1132634053152331776 / 662755857462779 := j_eq_iff.mpr (by decide +kernel)
