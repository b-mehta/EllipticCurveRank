...
transported to the integral short model, are in `data/curve19.txt`; descent labels are in
`data/curve19-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve19_j : curve19.j = 35315050222442294737770643456 / 17606837538436654482975 := j_eq_iff.mpr (by decide +kernel)
