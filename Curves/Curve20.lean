...
transported to the integral short model, are in `data/curve20.txt`; descent labels are in
`data/curve20-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve20_j : curve20.j = 803603536618091542566827344 / 373668526980316722179025 := j_eq_iff.mpr (by decide +kernel)
