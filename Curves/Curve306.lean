...
transported to the integral short model, are in `data/curve306.txt`; descent labels are in
`data/curve306-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve306_j : curve306.j = 5576254712865363483053752237070781870823751441932635272834295844912316983392992742007 / 145407453776393801820203291860281234365941933072529682700344994630930896663750000 := j_eq_iff.mpr (by decide +kernel)
