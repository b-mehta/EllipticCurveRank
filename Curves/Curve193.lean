...
transported to the integral short model, are in `data/curve193.txt`; descent labels are in
`data/curve193-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve193_j : curve193.j = 73644934304869873813426088201777728890797943990126519718218634558433869201 / 11801171435734791180357853315012481673861744917479863238791703372800000 := j_eq_iff.mpr (by decide +kernel)
