...
transported to the integral short model, are in `data/curve186.txt`; descent labels are in
`data/curve186-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve186_j : curve186.j = 12347832031628432752954334365847259791791097562142503628310122665708286249 / 233967633902633983979755459859152071254151669331191204489323520000000 := j_eq_iff.mpr (by decide +kernel)
