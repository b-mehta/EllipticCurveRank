...
transported to the integral short model, are in `data/curve210.txt`; descent labels are in
`data/curve210-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve210_j : curve210.j = 349725985056112432278745059291246288657731140219920503008599854808842330415765359123777569 / 48857429671295622571237789586614535277793367429869518495768693667778413208750462668800 := j_eq_iff.mpr (by decide +kernel)
