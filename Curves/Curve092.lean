...
@[expose] public def curve092 : WeierstrassCurve ℚ :=
...
public theorem curve092_hasRankGE_20 : HasRankGE curve092 20 := by
  unfold curve092
  certify_curve torsion 37 "data/curve092.txt" "data/curve092-labels.txt"
