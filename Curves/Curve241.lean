...
transported to the integral short model, are in `data/curve241.txt`; descent labels are in
`data/curve241-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve241_j : curve241.j = 2992927629164878617015030101337837028781876776575774882001656942675169 / 8813761630935831317440473226115886471150831299234006905672050675 := j_eq_iff.mpr (by decide +kernel)
