...
transported to the integral short model, are in `data/curve73.txt`; descent labels are in
`data/curve73-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve73_j : curve73.j = 1680650094760075832375792186207105980231695336102201698790092916703099329537832635384474592916981749350524551013981 / 586284466816895441725016823462228572336614970829564783090569981377101688741165246294300633474434802231794941952 := j_eq_iff.mpr (by decide +kernel)
