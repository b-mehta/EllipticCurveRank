...
transported to the integral short model, are in `data/curve212.txt`; descent labels are in
`data/curve212-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve212_j : curve212.j = 1174560429575150237826421944015643285827315118865246188670602670464080987030718985375416516 / 151459489927613924435192147605383698237111010070861338842066555060058382601407336344525 := j_eq_iff.mpr (by decide +kernel)
