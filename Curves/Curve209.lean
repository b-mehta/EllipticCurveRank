...
transported to the integral short model, are in `data/curve209.txt`; descent labels are in
`data/curve209-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve209_j : curve209.j = 100604907018216673558266200465187546539410005976586291375160761720231536253102042904562947710161 / 1338564298715068084238032509236132656932831181570255662241548306776016518665875079823360000 := j_eq_iff.mpr (by decide +kernel)
