...
transported to the integral short model, are in `data/curve234.txt`; descent labels are in
`data/curve234-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve234_j : curve234.j = -2351734316006072914007028216025104616202076075008992913181137205785940920829769 / 325021758664267435353269545802736616838357964735913965003055852319441700 := j_eq_iff.mpr (by decide +kernel)
