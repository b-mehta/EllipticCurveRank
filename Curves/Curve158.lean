...
transported to the integral short model, are in `data/curve158.txt`; descent labels are in
`data/curve158-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve158_j : curve158.j = -730836591023566422475539482791936 / 39145426572195170656486418763 := j_eq_iff.mpr (by decide +kernel)
