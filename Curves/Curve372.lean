...
transported to the integral short model, are in `data/curve372.txt`; descent labels are in
`data/curve372-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve372_j : curve372.j = 11877760680289352716041 / 4260225849214102372 := j_eq_iff.mpr (by decide +kernel)
