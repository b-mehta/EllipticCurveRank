...
transported to the integral short model, are in `data/curve16.txt`; descent labels are in
`data/curve16-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve16_j : curve16.j = 341913290879033644447936 / 2174505011398265625 := j_eq_iff.mpr (by decide +kernel)
