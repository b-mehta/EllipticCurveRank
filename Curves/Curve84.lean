...
transported to the integral short model, are in `data/curve84.txt`; descent labels are in
`data/curve84-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve84_j : curve84.j = -1603638291915355209486336 / 103294665688000244363 := j_eq_iff.mpr (by decide +kernel)
