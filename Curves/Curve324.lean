...
transported to the integral short model, are in `data/curve324.txt`; descent labels are in
`data/curve324-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve324_j : curve324.j = -3879853268933444053891150158690472842334572210199062153047673539945996595529 / 28986743484558431194750287524549274861356418077344360765954063541056900 := j_eq_iff.mpr (by decide +kernel)
