...
transported to the integral short model, are in `data/curve330.txt`; descent labels are in
`data/curve330-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve330_j : curve330.j = 12160682249692098319588156233563740596787144380450135608207304325054010532869107794015489316 / 30554450888584242786872177034566167206109893576281438157362516501526369675685058094525 := j_eq_iff.mpr (by decide +kernel)
