...
transported to the integral short model, are in `data/curve27.txt`; descent labels are in
`data/curve27-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve27_j : curve27.j = 14499156657276224279322827273382391293904 / 179233293942874401038192528800323525 := j_eq_iff.mpr (by decide +kernel)
