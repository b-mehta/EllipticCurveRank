...
transported to the integral short model, are in `data/curve375.txt`; descent labels are in
`data/curve375-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve375_j : curve375.j = 788328285858748360075259301653156966343346545487398630469431668884169998645304809 / 5819455440532883078558130408532245184972505919864122540273680906080000000000 := j_eq_iff.mpr (by decide +kernel)
