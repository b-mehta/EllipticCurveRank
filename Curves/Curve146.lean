...
transported to the integral short model, are in `data/curve146.txt`; descent labels are in
`data/curve146-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve146_j : curve146.j = 1213937539240224171360397878452987978473182047048439155869853484629916363217 / 51916762541332422595394109101873175611979790815209442814272781969211364 := j_eq_iff.mpr (by decide +kernel)
