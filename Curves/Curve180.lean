...
transported to the integral short model, are in `data/curve180.txt`; descent labels are in
`data/curve180-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve180_j : curve180.j = 171580030053285220722588775598135163007710495071296198745588477116021793 / 7801118878730336103423283788352286036165891308796795980262239436800 := j_eq_iff.mpr (by decide +kernel)
