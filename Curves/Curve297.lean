...
transported to the integral short model, are in `data/curve297.txt`; descent labels are in
`data/curve297-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve297_j : curve297.j = 161258299955760047236170103522926762675371616097702341870534073861788152873683244359591102752707382168608569 / 2889676282644760701646098069901030473735322608308703495604579825568384807289002485392265357621309440000 := j_eq_iff.mpr (by decide +kernel)
