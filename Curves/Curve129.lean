...
transported to the integral short model, are in `data/curve129.txt`; descent labels are in
`data/curve129-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve129_j : curve129.j = 48274035531192538704 / 196383966667225 := j_eq_iff.mpr (by decide +kernel)
