...
transported to the integral short model, are in `data/curve190.txt`; descent labels are in
`data/curve190-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve190_j : curve190.j = 383923158845566564666580665798600967317629666608480381388681118782283799897454289 / 2002759759339260333083343920570400172836681708972713617207563581365767372800 := j_eq_iff.mpr (by decide +kernel)
