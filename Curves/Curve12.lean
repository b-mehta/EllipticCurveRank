...
@[expose] public def curve12 : WeierstrassCurve ℚ :=
...
public theorem curve12_hasRankGE_29 : HasRankGE curve12 29 := by
  unfold curve12
...
public instance : curve12.IsElliptic := isElliptic_of_Δ_ne_zero (by decide +kernel)

set_option linter.style.longLine false in
/-- The `j`-invariant of curve 12. -/
public theorem curve12_j : curve12.j = -2178278186417661901253576189103582365997935396472623778840162578414756885078160008166998745534482953456950649575682874999212260264866779577866068298184392291373758903459432104260760768986641 / 58514056884179895803252795545068205623215359270190478217393508483140281138663769634024489915971980794469429246265449489823479442097938729025702174957426421151737866434992604323840000000 :=
