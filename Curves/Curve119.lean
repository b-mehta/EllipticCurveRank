...
transported to the integral short model, are in `data/curve119.txt`; descent labels are in
`data/curve119-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve119_j : curve119.j = -6577042272256 / 9694585723 := j_eq_iff.mpr (by decide +kernel)
