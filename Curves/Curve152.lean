...
transported to the integral short model, are in `data/curve152.txt`; descent labels are in
`data/curve152-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve152_j : curve152.j = 370202545542100435703721 / 4577605239223007632 := j_eq_iff.mpr (by decide +kernel)
