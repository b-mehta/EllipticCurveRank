...
transported to the integral short model, are in `data/curve24.txt`; descent labels are in
`data/curve24-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve24_j : curve24.j = 5890190437726738405327986193744 / 5660243641291976370659025 := j_eq_iff.mpr (by decide +kernel)
