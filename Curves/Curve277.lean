...
transported to the integral short model, are in `data/curve277.txt`; descent labels are in
`data/curve277-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve277_j : curve277.j = 4653682275070694592 / 407886758401321 := j_eq_iff.mpr (by decide +kernel)
