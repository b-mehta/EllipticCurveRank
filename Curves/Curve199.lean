...
transported to the integral short model, are in `data/curve199.txt`; descent labels are in
`data/curve199-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve199_j : curve199.j = -998111122979483578061542693901648305995589525204645301641605323632809980564888443203235113786351649 / 5290724783356970045570091261064369041862691109828850503901233859803837652758778996437693235200 := j_eq_iff.mpr (by decide +kernel)
