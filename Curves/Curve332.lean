...
transported to the integral short model, are in `data/curve332.txt`; descent labels are in
`data/curve332-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve332_j : curve332.j = -75099004244102664596789411022909516721866737293686914992578014052525349889794248524649833953 / 17167909180637480883395526936559530872769554325924464584539224547488746121889587183616 := j_eq_iff.mpr (by decide +kernel)
