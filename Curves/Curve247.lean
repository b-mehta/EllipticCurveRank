...
transported to the integral short model, are in `data/curve247.txt`; descent labels are in
`data/curve247-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve247_j : curve247.j = -10126096574767163162617928 / 2093176027036499 := j_eq_iff.mpr (by decide +kernel)
