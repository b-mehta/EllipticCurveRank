...
transported to the integral short model, are in `data/curve346.txt`; descent labels are in
`data/curve346-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve346_j : curve346.j = -497587634412316695468599019472446112983691560731908827698521707090365944734792679503752065208401 / 8153715222927956302195203530071282231036456187252543215356220806381515287867179840000000000 := j_eq_iff.mpr (by decide +kernel)
