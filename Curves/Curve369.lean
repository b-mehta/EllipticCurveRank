...
transported to the integral short model, are in `data/curve369.txt`; descent labels are in
`data/curve369-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve369_j : curve369.j = -5685108812391047578576 / 264708770551352883 := j_eq_iff.mpr (by decide +kernel)
