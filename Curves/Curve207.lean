...
transported to the integral short model, are in `data/curve207.txt`; descent labels are in
`data/curve207-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve207_j : curve207.j = -839692966510787338234913549715848798864558983549878252014023265968348940687406914770378216913 / 3422870604766236676640461540968597637385614986383819869199981932113776785925252020121600 := j_eq_iff.mpr (by decide +kernel)
