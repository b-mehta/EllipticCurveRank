...
transported to the integral short model, are in `data/curve322.txt`; descent labels are in
`data/curve322-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve322_j : curve322.j = 98599192328140736370356464797657623429162235639359538375197697889730160289926826249 / 9601181115750078873408882514666060846796833154512780600357817958099863923200000 := j_eq_iff.mpr (by decide +kernel)
