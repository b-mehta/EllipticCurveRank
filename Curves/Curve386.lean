...
transported to the integral short model, are in `data/curve386.txt`; descent labels are in
`data/curve386-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve386_j : curve386.j = 53260400822714486824425942953062167195205735695126629162910366927218075658989685885351180528401056873 / 3881445147849499147057933223105448713025576988092326174222087859111706187637652890915854716502016 := j_eq_iff.mpr (by decide +kernel)
