...
transported to the integral short model, are in `data/curve116.txt`; descent labels are in
`data/curve116-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve116_j : curve116.j = 86877680157268273 / 6822208199 := j_eq_iff.mpr (by decide +kernel)
