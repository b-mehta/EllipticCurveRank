...
transported to the integral short model, are in `data/curve340.txt`; descent labels are in
`data/curve340-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve340_j : curve340.j = 13630123018362204255669878653878852202911501916191268565385958380709020985919167850497 / 76849466769297782831711790936994283644159673630162135892534857526817112555900196 := j_eq_iff.mpr (by decide +kernel)
