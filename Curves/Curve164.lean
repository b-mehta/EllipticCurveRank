...
transported to the integral short model, are in `data/curve164.txt`; descent labels are in
`data/curve164-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve164_j : curve164.j = -18245772615362737242635020688179842039641715002378927599458636447227404557001 / 96596297785511176202492530185517282392591841996495669883144724779827200 := j_eq_iff.mpr (by decide +kernel)
