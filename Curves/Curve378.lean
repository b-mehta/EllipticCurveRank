...
transported to the integral short model, are in `data/curve378.txt`; descent labels are in
`data/curve378-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve378_j : curve378.j = -25563376636988401920872712436183753485261168252215741207856607208880091451776944175899435311739715124325563309438516326096 / 69651499689033310599477700552365182969329108566516764990738938069452593816146500869269694450585881805144754933046875 := j_eq_iff.mpr (by decide +kernel)
