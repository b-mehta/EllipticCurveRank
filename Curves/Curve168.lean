...
transported to the integral short model, are in `data/curve168.txt`; descent labels are in
`data/curve168-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve168_j : curve168.j = 120633586947083765385366874558742798749564527915754238548350411616387713118913 / 17269791433986961699118075821819682707862187898136536760943740514838118400 := j_eq_iff.mpr (by decide +kernel)
