...
transported to the integral short model, are in `data/curve331.txt`; descent labels are in
`data/curve331-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve331_j : curve331.j = 854030697829260082556902220633116012266776148135418838408206407553210432379733471540421321 / 120026114450375268731550080313050637490976047007792951958607127362398246018745515426132 := j_eq_iff.mpr (by decide +kernel)
