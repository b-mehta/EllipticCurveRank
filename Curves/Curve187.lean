...
transported to the integral short model, are in `data/curve187.txt`; descent labels are in
`data/curve187-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve187_j : curve187.j = -6513647187543870833172410756270145944047250180835110110077755581497080214919973089 / 2022211713991403952643989329426518524793000170608832607992621018508718899200 := j_eq_iff.mpr (by decide +kernel)
