...
transported to the integral short model, are in `data/curve285.txt`; descent labels are in
`data/curve285-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve285_j : curve285.j = -137534956958959875658649865753985413726619184818863411281142671036870152384737443964383524 / 227910338112679744969436886726814874185266384845663734114678771476940316478016394667 := j_eq_iff.mpr (by decide +kernel)
