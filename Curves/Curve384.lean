...
transported to the integral short model, are in `data/curve384.txt`; descent labels are in
`data/curve384-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve384_j : curve384.j = -31562012559558477201324330637876379684744483542417065866760022981090788481102218110496977521 / 8048982908040164938257367514212363435923458637934622402798571165236429219655936000000000 := j_eq_iff.mpr (by decide +kernel)
