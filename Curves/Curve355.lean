...
transported to the integral short model, are in `data/curve355.txt`; descent labels are in
`data/curve355-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve355_j : curve355.j = -598759585213272469834650218141939424198494810521287232606863936797473953909834551605208540901255130017769 / 5405924406643097152871863414800036170204499282075405190916903108371104984202443269706572645658954375 := j_eq_iff.mpr (by decide +kernel)
