...
transported to the integral short model, are in `data/curve223.txt`; descent labels are in
`data/curve223-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve223_j : curve223.j = -401058335438813143213971079227539137282297678323233972078130987443011574683009 / 3813252252629096528179660181276040684149024921496063243047757455898622500 := j_eq_iff.mpr (by decide +kernel)
