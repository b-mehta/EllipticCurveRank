...
transported to the integral short model, are in `data/curve6.txt`; descent labels are in
`data/curve6-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve6_j : curve6.j = 1333438333072655800326576346053542744191520910532032219284532006731512699546815066841 / 132627604887993808721569697584392184353609155330366997097523327475919340037734400 := j_eq_iff.mpr (by decide +kernel)
