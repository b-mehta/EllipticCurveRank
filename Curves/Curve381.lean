...
transported to the integral short model, are in `data/curve381.txt`; descent labels are in
`data/curve381-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve381_j : curve381.j = 146491137762203728471853115124942944542953167854279935239670236835120724142312170413881633801 / 1535861076553756069541566097526976300456021823719770432861083465864224153832843577587500 := j_eq_iff.mpr (by decide +kernel)
