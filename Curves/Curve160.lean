...
transported to the integral short model, are in `data/curve160.txt`; descent labels are in
`data/curve160-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve160_j : curve160.j = -59546996862613172299059277421620438364212604366648944777538524529047394936841649 / 1110471669081969085126829746172651769282872411042233998981380763261191722500 := j_eq_iff.mpr (by decide +kernel)
