...
transported to the integral short model, are in `data/curve359.txt`; descent labels are in
`data/curve359-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve359_j : curve359.j = -12468718350418033281788549584 / 971309421327543832019475 := j_eq_iff.mpr (by decide +kernel)
