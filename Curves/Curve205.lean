...
transported to the integral short model, are in `data/curve205.txt`; descent labels are in
`data/curve205-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve205_j : curve205.j = -128871480411962973459918638542369651526670377341462228301748036310485143871711035012 / 958966033340847435693437307012100399015394930580958465273641310764388555386275 := j_eq_iff.mpr (by decide +kernel)
