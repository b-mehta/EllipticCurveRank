...
transported to the integral short model, are in `data/curve18.txt`; descent labels are in
`data/curve18-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve18_j : curve18.j = 1428358461822810424179949568 / 1769156629341263370351 := j_eq_iff.mpr (by decide +kernel)
