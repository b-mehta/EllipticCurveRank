...
transported to the integral short model, are in `data/curve217.txt`; descent labels are in
`data/curve217-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve217_j : curve217.j = 1109773255208910277577034518246441221406516454134412700698782845473 / 15186528023219984188634768546364937506656281214045339786116 := j_eq_iff.mpr (by decide +kernel)
