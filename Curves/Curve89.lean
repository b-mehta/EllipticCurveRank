...
transported to the integral short model, are in `data/curve89.txt`; descent labels are in
`data/curve89-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve89_j : curve89.j = 120278669541754867122691336375296 / 4781580467928154293492273157 := j_eq_iff.mpr (by decide +kernel)
