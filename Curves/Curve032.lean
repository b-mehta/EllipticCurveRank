...
@[expose] public def curve032 : WeierstrassCurve ℚ :=
  ⟨1, 0, 0, -3414948705808928485, 1462640470912335058581199361⟩

/-- ICARM leaderboard curve 32 has Mordell-Weil rank at least `10`. -/
public theorem curve032_hasRankGE_10 : HasRankGE curve032 10 := by
  unfold curve032
  certify_curve oneTorsion 6308836808 5 "data/curve032.txt" "data/curve032-labels.txt"
