...
transported to the integral short model, are in `data/curve333.txt`; descent labels are in
`data/curve333-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve333_j : curve333.j = 96518909703233033434163617276493273887941846775696513023061140661309602612570057630457 / 137731644332816948398017774920067097767253737948852991745512420846250430440914944 := j_eq_iff.mpr (by decide +kernel)
