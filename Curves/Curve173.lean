...
transported to the integral short model, are in `data/curve173.txt`; descent labels are in
`data/curve173-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve173_j : curve173.j = 161119040527647852163929023068926433747235212920516305289784520284239058633 / 6099809981089129676651516316527461695505967731631551375750008846336 := j_eq_iff.mpr (by decide +kernel)
