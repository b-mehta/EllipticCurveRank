...
transported to the integral short model, are in `data/curve206.txt`; descent labels are in
`data/curve206-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve206_j : curve206.j = 5789257252176448678636349102426000827302087640431977695817089449036239484363937419021387134689 / 251453575815775763875321183856781238190717796098320943436148000167676873962388406215526400 := j_eq_iff.mpr (by decide +kernel)
