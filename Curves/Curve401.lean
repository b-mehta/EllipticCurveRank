...
transported to the integral short model, are in `data/curve401.txt`; descent labels are in
`data/curve401-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve401_j : curve401.j = -13382918600625857335997524990265996642932576167788690918683487936008853656027667774920757309082091251064765905279002807695824 / 107553205467814304019096825942534431000736889727717739538830973347619492173257407050628227295918410158121168306205318355 := j_eq_iff.mpr (by decide +kernel)
