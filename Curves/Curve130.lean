...
transported to the integral short model, are in `data/curve130.txt`; descent labels are in
`data/curve130-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve130_j : curve130.j = 41105095360047286281 / 10698400790403652 := j_eq_iff.mpr (by decide +kernel)
