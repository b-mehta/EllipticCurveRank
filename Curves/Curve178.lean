...
transported to the integral short model, are in `data/curve178.txt`; descent labels are in
`data/curve178-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve178_j : curve178.j = -66269446999022735422995542778655688628047999436367325736362859041338587257881 / 15984702572616129644036067033158033960203960410133606255083019758950400 := j_eq_iff.mpr (by decide +kernel)
