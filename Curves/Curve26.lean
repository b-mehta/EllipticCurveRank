...
transported to the integral short model, are in `data/curve26.txt`; descent labels are in
`data/curve26-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve26_j : curve26.j = 27930286822977979655852256482253328 / 1728175896617050441636406899425 := j_eq_iff.mpr (by decide +kernel)
