...
transported to the integral short model, are in `data/curve176.txt`; descent labels are in
`data/curve176-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve176_j : curve176.j = 1896858489830426321635095174492419814689323279739907825163447575257 / 15608105462218022394741001041284679218977813496713703148748800 := j_eq_iff.mpr (by decide +kernel)
