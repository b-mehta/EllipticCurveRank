...
over `ℚ`. It has Mordell-Weil rank at least `23`. The witness points from the leaderboard,
transported to the integral short model, are in `data/curve377.txt`; descent labels are in
`data/curve377-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve377_j : curve377.j = -17145993996429135212641572489109473241542610621335582947924144151935478700836284536562469615247548457045456 / 37744782380097514277218982776136465685885790310144603587922266015763857726976168099896069240777921875 := j_eq_iff.mpr (by decide +kernel)
