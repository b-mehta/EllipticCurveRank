...
transported to the integral short model, are in `data/curve139.txt`; descent labels are in
`data/curve139-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve139_j : curve139.j = -20352850745542350272894906361 / 505896333231836385777788 := j_eq_iff.mpr (by decide +kernel)
