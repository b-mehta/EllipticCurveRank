...
transported to the integral short model, are in `data/curve215.txt`; descent labels are in
`data/curve215-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve215_j : curve215.j = -1285557548034318479609724696653841069719710141900939767749424462633 / 275475969825108185987893345338322452777752095414932289353778364 := j_eq_iff.mpr (by decide +kernel)
