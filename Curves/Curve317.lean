...
transported to the integral short model, are in `data/curve317.txt`; descent labels are in
`data/curve317-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve317_j : curve317.j = 8890508867207217481939709033561558715397718102886616500543423826121569 / 115017721248537024791512873609799594141037969992867713718881894400 := j_eq_iff.mpr (by decide +kernel)
