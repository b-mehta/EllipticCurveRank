...
transported to the integral short model, are in `data/curve256.txt`; descent labels are in
`data/curve256-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve256_j : curve256.j = 741801759994238976 / 429283425922619 := j_eq_iff.mpr (by decide +kernel)
