...
transported to the integral short model, are in `data/curve222.txt`; descent labels are in
`data/curve222-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve222_j : curve222.j = -5606962197043039969108549947867214861860287407997389732530461976009 / 1393608587867013417022486645821340865286408196726383194163200000 := j_eq_iff.mpr (by decide +kernel)
