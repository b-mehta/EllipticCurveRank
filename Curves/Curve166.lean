...
transported to the integral short model, are in `data/curve166.txt`; descent labels are in
`data/curve166-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve166_j : curve166.j = 7605127164328521086410893863528841271018548599265400258335350798998117793209 / 1581713212839919538549215829096503759085229478779799109779343216640000 := j_eq_iff.mpr (by decide +kernel)
