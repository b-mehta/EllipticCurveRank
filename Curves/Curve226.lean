...
transported to the integral short model, are in `data/curve226.txt`; descent labels are in
`data/curve226-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve226_j : curve226.j = -16769181173589727873782247531970437045601133482103485398023188599776346363946448714530690742888822241 / 355568117955757642974912655755100242442938536081550074372306129807997878195940027796106400000000 := j_eq_iff.mpr (by decide +kernel)
