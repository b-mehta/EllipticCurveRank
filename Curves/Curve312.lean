...
transported to the integral short model, are in `data/curve312.txt`; descent labels are in
`data/curve312-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve312_j : curve312.j = 102510323371745118594907183909901892780304308669271316267736036322296680112451613253571826020242825507157393976878649328368720252963 / 2210047804093149601165852365406954218789846145616180545895038969403819193492749149764720830803432395722064899167809284105527296 := j_eq_iff.mpr (by decide +kernel)
