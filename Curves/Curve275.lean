...
transported to the integral short model, are in `data/curve275.txt`; descent labels are in
`data/curve275-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve275_j : curve275.j = -931299477114920794949720523496110433048090905702531271730340331493514008514128797768393 / 16197498753307130570718466689601294928007257164818990602909253701371655741958401236 := j_eq_iff.mpr (by decide +kernel)
