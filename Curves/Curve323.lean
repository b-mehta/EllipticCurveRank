...
transported to the integral short model, are in `data/curve323.txt`; descent labels are in
`data/curve323-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve323_j : curve323.j = -12898502833945465541569569057285369753329029640934501685283689320049998807683610775826576332273 / 961192558763116104494174560156552740369599525184419354704623810269290750248214752575717376 := j_eq_iff.mpr (by decide +kernel)
