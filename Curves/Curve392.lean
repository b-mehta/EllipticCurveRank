...
transported to the integral short model, are in `data/curve392.txt`; descent labels are in
`data/curve392-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve392_j : curve392.j = -90823396437863227068686159812849 / 14277544295858814611865600 := j_eq_iff.mpr (by decide +kernel)
