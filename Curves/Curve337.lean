...
transported to the integral short model, are in `data/curve337.txt`; descent labels are in
`data/curve337-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve337_j : curve337.j = 555349158179604610508339626263519555456763270946686349093119341167993870973719760603751381999 / 232695028279417510285511346045636730895770330550311487009211639649911770985806046535065600 := j_eq_iff.mpr (by decide +kernel)
