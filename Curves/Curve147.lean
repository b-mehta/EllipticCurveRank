...
transported to the integral short model, are in `data/curve147.txt`; descent labels are in
`data/curve147-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve147_j : curve147.j = -3118559544780734398050017625914583868005128181022561460140274470385125570801 / 40091900068111500354981590451888913785493616412246049722990279496695808 := j_eq_iff.mpr (by decide +kernel)
