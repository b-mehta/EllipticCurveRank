...
transported to the integral short model, are in `data/curve177.txt`; descent labels are in
`data/curve177-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve177_j : curve177.j = 23914891950718945755043605497931276071435002145212436790674004201328795681 / 81438791243922645157611866031099042317832628278473480004951449600000 := j_eq_iff.mpr (by decide +kernel)
