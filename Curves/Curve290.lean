...
transported to the integral short model, are in `data/curve290.txt`; descent labels are in
`data/curve290-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve290_j : curve290.j = 444210049222489621477608429562013018012674903372400794907658987789496747104083929 / 11270649661159432034309229020483247353533212692858049368372285851855011840000 := j_eq_iff.mpr (by decide +kernel)
