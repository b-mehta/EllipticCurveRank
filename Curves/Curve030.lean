...
@[expose] public def curve030 : WeierstrassCurve ℚ := ⟨1, -1, 1, -1608154463, 25555312501831⟩

/-- ICARM leaderboard curve 30 has Mordell-Weil rank at least `9`. -/
public theorem curve030_hasRankGE_9 : HasRankGE curve030 9 := by
  unfold curve030
  certify_curve torsion 7 "data/curve030.txt" "data/curve030-labels.txt"

/-- Curve 30 is elliptic (nonzero discriminant), so its `j`-invariant is defined. -/
public instance : curve030.IsElliptic := isElliptic_of_Δ_ne_zero (by decide +kernel)

set_option linter.style.longLine false in
/-- The `j`-invariant of curve 30. -/
public theorem curve030_j : curve030.j = -630927510631066796771741791401 / 21874549145075356208537600 :=
