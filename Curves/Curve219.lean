...
transported to the integral short model, are in `data/curve219.txt`; descent labels are in
`data/curve219-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve219_j : curve219.j = 49593850241039536270516133526307573019601834553795431231177253841479535689 / 18328723162152475758783373844977983009407970299659748341711623258000900 := j_eq_iff.mpr (by decide +kernel)
