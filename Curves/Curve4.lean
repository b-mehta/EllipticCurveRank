...
transported to the integral short model, are in `data/curve4.txt`; descent labels are in
`data/curve4-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve4_j : curve4.j = 1021443474905391887241185106080413458447526690942639338949427731389929043874380451061511113041 / 284205064269551456641094292955182094002428922847801912953464227178522579040000000000000000 := j_eq_iff.mpr (by decide +kernel)
