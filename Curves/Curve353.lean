...
transported to the integral short model, are in `data/curve353.txt`; descent labels are in
`data/curve353-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve353_j : curve353.j = -14320544650303169791402548841 / 300733579435137404332500 := j_eq_iff.mpr (by decide +kernel)
