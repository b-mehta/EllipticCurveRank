...
transported to the integral short model, are in `data/curve28.txt`; descent labels are in
`data/curve28-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve28_j : curve28.j = 15380486595963878931284986830701025482704 / 182608770943041829223331085857933525 := j_eq_iff.mpr (by decide +kernel)
