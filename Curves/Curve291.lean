...
transported to the integral short model, are in `data/curve291.txt`; descent labels are in
`data/curve291-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve291_j : curve291.j = 31844611072083867626865275224217865135441994937911558417029003592489253273460911238616408140241 / 14215435830148235529799662352264068087312446526429440014425522664485131428771957496217600 := j_eq_iff.mpr (by decide +kernel)
