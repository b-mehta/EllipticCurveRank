...
transported to the integral short model, are in `data/curve335.txt`; descent labels are in
`data/curve335-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve335_j : curve335.j = -199987968288710035339070918772119097091746778424038342034225103645918398924732188356027769 / 14615989348765440907218560677725984426032031787567606231387690003057470444255436800000 := j_eq_iff.mpr (by decide +kernel)
