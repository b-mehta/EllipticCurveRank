...
@[expose] public def curve022 : WeierstrassCurve ℚ := ⟨0, -1, 0, -1664597956, 26095909440100⟩

/-- ICARM leaderboard curve 22 has Mordell-Weil rank at least `6`. -/
public theorem curve022_hasRankGE_6 : HasRankGE curve022 6 := by
  unfold curve022
  certify_curve oneTorsion 91012 29 "data/curve022.txt" "data/curve022-labels.txt"

/-- Curve 22 is elliptic (nonzero discriminant), so its `j`-invariant is defined. -/
public instance : curve022.IsElliptic := isElliptic_of_Δ_ne_zero (by decide +kernel)

set_option linter.style.longLine false in
/-- The `j`-invariant of curve 22. -/
public theorem curve022_j : curve022.j = 1992561882830305777698340062544 / 3970233989185030110569025 :=
