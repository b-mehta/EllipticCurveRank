...
transported to the integral short model, are in `data/curve257.txt`; descent labels are in
`data/curve257-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve257_j : curve257.j = 27972643918500488448 / 16188152231151383 := j_eq_iff.mpr (by decide +kernel)
