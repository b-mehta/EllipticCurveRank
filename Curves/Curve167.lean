...
transported to the integral short model, are in `data/curve167.txt`; descent labels are in
`data/curve167-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve167_j : curve167.j = -12248326090032710479397653967897226856912283609028084419976207113881 / 508004324086258229695901640128237130508912591579698075573043200 := j_eq_iff.mpr (by decide +kernel)
