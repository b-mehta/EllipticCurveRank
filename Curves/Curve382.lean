...
transported to the integral short model, are in `data/curve382.txt`; descent labels are in
`data/curve382-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve382_j : curve382.j = 6458655695030924799680837238449902603221686759966097418737315873593696049304830776225929 / 87384268844224104438296085063546882152108836445459219835470052461304735788797440000 := j_eq_iff.mpr (by decide +kernel)
