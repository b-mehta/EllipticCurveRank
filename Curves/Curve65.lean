...
transported to the integral short model, are in `data/curve65.txt`; descent labels are in
`data/curve65-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve65_j : curve65.j = -202096542159422198898674776173816549955496049738612716727844469925310546840605901865863706389701428955168474644189762367560151868801 / 1648077180048519919196851388268507997232089165506048976474499224670899793965899322864689351309245989194390271909250018304000000 := j_eq_iff.mpr (by decide +kernel)
