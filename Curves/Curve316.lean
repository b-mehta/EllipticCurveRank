...
transported to the integral short model, are in `data/curve316.txt`; descent labels are in
`data/curve316-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve316_j : curve316.j = 184391739121880065105208192710402274808760053284557828001218670228487988047900806178769 / 89176446007892832942170673747379791745757428321235958497602360325335450136985600 := j_eq_iff.mpr (by decide +kernel)
