...
transported to the integral short model, are in `data/curve269.txt`; descent labels are in
`data/curve269-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve269_j : curve269.j = 21266853711813353780928 / 12307169240705355733 := j_eq_iff.mpr (by decide +kernel)
