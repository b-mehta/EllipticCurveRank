...
transported to the integral short model, are in `data/curve342.txt`; descent labels are in
`data/curve342-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve342_j : curve342.j = -19072297061661906233771206794438138147139792092705583902100207882252073076156931994881342057 / 14370849162198941469327508393310482958635155172283852397156245276330989449210056441856 := j_eq_iff.mpr (by decide +kernel)
