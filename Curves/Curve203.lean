...
transported to the integral short model, are in `data/curve203.txt`; descent labels are in
`data/curve203-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve203_j : curve203.j = -36289252941788492228014277929242790315626075343859363926982953 / 859076487022818729321026088704523026210935982019962548656 := j_eq_iff.mpr (by decide +kernel)
