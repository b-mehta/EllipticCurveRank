...
transported to the integral short model, are in `data/curve397.txt`; descent labels are in
`data/curve397-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve397_j : curve397.j = -7867772035879162626763025006949318607503813367726011469109045935072672855549794819954521149438721857561 / 2641855116834374132577871224152810511120637442035180975087019855118289801626482364997169495375887500 := j_eq_iff.mpr (by decide +kernel)
