...
transported to the integral short model, are in `data/curve345.txt`; descent labels are in
`data/curve345-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve345_j : curve345.j = 2567381312378641934111041928290166475319811411825816551509053899686223977916903553 / 252875348430269250279547286234207310670836340483994640182484967790285287913775 := j_eq_iff.mpr (by decide +kernel)
