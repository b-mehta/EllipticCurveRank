...
@[expose] public def curve074 : WeierstrassCurve ℚ :=
...
public theorem curve074_hasRankGE_21 : HasRankGE curve074 21 := by
  unfold curve074
  certify_curve torsion 11 "data/curve074.txt" "data/curve074-labels.txt"

/-- Curve 74 is elliptic (nonzero discriminant), so its `j`-invariant is defined. -/
public instance : curve074.IsElliptic := isElliptic_of_Δ_ne_zero (by decide +kernel)

set_option linter.style.longLine false in
/-- The `j`-invariant of curve 74. -/
public theorem curve074_j : curve074.j = 1112096004752851462729397594359132384395809315460462776640080386721422130341804188923888915794608773116288507441 / 479737754043767746536923774462246533556793859277365678757052823009411494064048885744243744500948985175040000 :=
