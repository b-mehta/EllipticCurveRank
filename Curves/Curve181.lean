...
transported to the integral short model, are in `data/curve181.txt`; descent labels are in
`data/curve181-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve181_j : curve181.j = -7049451401799301771124089763998247944772873668265237035427154742325953 / 293231918449934958705327201280235162673170146698422177169348591616 := j_eq_iff.mpr (by decide +kernel)
