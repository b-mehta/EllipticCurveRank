...
transported to the integral short model, are in `data/curve113.txt`; descent labels are in
`data/curve113-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve113_j : curve113.j = 1392059713710393 / 11479041604 := j_eq_iff.mpr (by decide +kernel)
