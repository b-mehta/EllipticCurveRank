...
transported to the integral short model, are in `data/curve153.txt`; descent labels are in
`data/curve153-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve153_j : curve153.j = 211137647347999957843881 / 4929094923734171152 := j_eq_iff.mpr (by decide +kernel)
