...
transported to the integral short model, are in `data/curve142.txt`; descent labels are in
`data/curve142-labels.txt`. The `certify_curve` tactic kernel-checks the resulting certificate.
-/
...
public theorem curve142_j : curve142.j = -4727343957618753381456 / 99679788594734375 := j_eq_iff.mpr (by decide +kernel)
